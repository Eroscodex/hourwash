                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        ...
                        @if(in_array($order->order_status, ['pending', 'cancelled']))
                            ...
                            <x-modal name="cust-delete-order-{{ $order->id }}" maxWidth="md">
                ...
                <div class="mt-4 pt-4 border-t border-slate-200 dark:border-zinc-800 space-y-3">
                    ...
                    @else
                        ...
                        <form method="POST" action="{{ route('feedback.store') }}" class="p-4 rounded-lg bg-slate-50 dark:bg-[#18181B] border border-slate-200 dark:border-zinc-800 space-y-3">
                            ...
                            <div class="space-y-3">
                                <div>
                                    <label for="rating-{{ $order->id }}" class="text-[11px] font-bold text-slate-700 dark:text-zinc-300 block mb-1.5 uppercase">Select Star Rating</label>
                                    <div class="flex flex-col sm:flex-row sm:items-center gap-2">
                                        <select id="rating-{{ $order->id }}" name="rating" class="w-full sm:w-64 py-2 px-3 rounded-lg bg-white dark:bg-[#141417] border border-slate-300 dark:border-zinc-700 text-slate-900 dark:text-zinc-100 text-xs font-bold focus:border-blue-600 focus:ring-1 focus:ring-blue-600 cursor-pointer shadow-sm" required>
                                        ...
                                        <span class="text-[11px] text-slate-500 dark:text-zinc-400 font-medium hidden sm:inline">Rate your wash &amp; store service experience</span>
                                    </div>
                                </div>

                                <div>
                                    <label for="comment-{{ $order->id }}" class="text-[11px] font-bold text-slate-700 dark:text-zinc-300 block mb-1 uppercase">Write Your Experience / Comment</label>
                                    <div class="flex flex-col sm:flex-row gap-2">
                                        <input type="text" id="comment-{{ $order->id }}" name="comment" placeholder="Tell us about your wash, dry, or fold experience..." class="flex-1 bg-white dark:bg-[#141417] border border-slate-300 dark:border-zinc-700 rounded-md px-3.5 py-2 text-xs focus:outline-none focus:border-blue-600 text-slate-900 dark:text-zinc-100" required>
