...
<body class="bg-slate-50 dark:bg-[#09090B] text-slate-900 dark:text-zinc-100 font-['Inter'] antialiased min-h-screen py-10 px-4 sm:px-6">
    <div class="w-full max-w-3xl mx-auto space-y-6">
        ...
        <!-- Main Content Card -->
        <main class="bg-white dark:bg-[#141417] border border-slate-200 dark:border-zinc-700/80 rounded-2xl p-6 sm:p-8 space-y-7 shadow-sm">
            <header class="text-center space-y-2 border-b border-slate-200 dark:border-zinc-700/80 pb-6">
            ...
            <div class="space-y-6 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
                ...
                <section class="space-y-2">
                    <h2 class="text-base font-bold text-slate-900 dark:text-white">Why Choose HourWash?</h2>
                ...
                <section class="space-y-3.5 border-t border-slate-200 dark:border-zinc-700/80 pt-5">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                        <h2 class="text-base font-bold text-slate-900 dark:text-white">Services Offered &amp; Official Pricing</h2>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 text-xs">
                        ...
                        <article class="p-4 rounded-lg bg-slate-50 dark:bg-[#18181B] border border-slate-200 dark:border-zinc-700/80 shadow-sm sm:col-span-2 hover:border-blue-500/40 transition">
                            <div class="flex items-center justify-between font-bold text-sm text-slate-900 dark:text-white mb-1.5">
                                <h3>Full-Service (Wash, Dry &amp; Fold)</h3>
