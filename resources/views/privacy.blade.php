    ...
    <div class="w-full max-w-3xl mx-auto space-y-6">
        ...
        <main class="bg-white dark:bg-[#141417] border border-slate-200 dark:border-zinc-600 rounded-lg p-6 sm:p-8 space-y-6 shadow-sm">
            ...
            <div class="space-y-6 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
                ...
                <section class="space-y-2">
                    <h2 class="text-base font-bold text-slate-900 dark:text-white pt-2">1. Information We Collect</h2>
                    <p>
                ...
                <section class="space-y-2">
                    <h2 class="text-base font-bold text-slate-900 dark:text-white pt-2">2. How We Use Your Information</h2>
                ...
                <section class="space-y-2">
                    <h2 class="text-base font-bold text-slate-900 dark:text-white pt-2">3. Data Security</h2>
                    <p>
                ...
                <section class="space-y-2">
                    <h2 class="text-base font-bold text-slate-900 dark:text-white pt-2">4. Third-Party Services</h2>
                    <p>
