                ...
                <table width="100%" max-width="600" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; background-color: #FFFFFF; border-radius: 20px; border: 1px solid #E2E8F0; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.06);">
                    ...
                    <tr>
                        <td align="center" style="background-color: #0F172A; padding: 28px 20px;">
                            <img src="https://hourwashlaundryshop.up.railway.app/favicon.svg" alt="Hour Wash Logo" width="56" height="56" style="display: block; margin: 0 auto 10px auto; border-radius: 50%; border: 2px solid #38BDF8;">
                    ...
                    <tr>
                        <td align="left" style="padding: 30px 24px;">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 28px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $url }}" target="_blank" style="display: inline-block; background-color: #007AFF; color: #FFFFFF; font-size: 14px; font-weight: 700; text-decoration: none; padding: 14px 32px; border-radius: 12px; box-shadow: 0 4px 14px rgba(0, 122, 255, 0.35);">
                                            Reset Password Now →
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <div style="margin-top: 28px; padding: 16px; background-color: #F8FAFC; border: 1px solid #E2E8F0; border-radius: 10px; font-size: 11px; color: #64748B; word-break: break-all;">
                                <p style="margin: 0 0 6px 0; font-weight: 600; color: #334155;">If you are having trouble clicking the "Reset Password Now" button, copy and paste the link below into your web browser:</p>
