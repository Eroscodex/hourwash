<x-app-layout>
    <div class="space-y-6 sm:space-y-8">
        ...
        <div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-2.5">
                ...
                <a href="{{ route('my.orders') }}"
                   class="p-3.5 rounded-lg bg-white dark:bg-[#18181B] border border-slate-200/80 dark:border-zinc-800 border-l-4 border-l-indigo-500 hover:border-indigo-500 dark:hover:border-indigo-500 transition-colors group shadow-sm">
        ...
        <div class="grid grid-cols-3 lg:grid-cols-4 gap-2.5 sm:gap-3">
            <div class="p-3.5 sm:p-4 rounded-lg bg-white dark:bg-[#18181B] border border-slate-200/80 dark:border-zinc-800 border-l-4 border-l-teal-500 shadow-sm">
                <div>
            ...
            <div class="p-3.5 sm:p-4 rounded-lg bg-white dark:bg-[#18181B] border border-slate-200/80 dark:border-zinc-800 border-l-4 border-l-blue-600 shadow-sm">
                <div>
            ...
            <div class="col-span-3 lg:col-span-1 p-3.5 sm:p-4 rounded-lg bg-white dark:bg-[#18181B] border border-slate-200/80 dark:border-zinc-800 border-l-4 {{ ($storeStatus ?? 'open') === 'open' ? 'border-l-emerald-500' : 'border-l-rose-500' }} flex flex-col justify-center shadow-sm">
                <div>
