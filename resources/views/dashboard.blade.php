                ...
                <section class="p-5 sm:p-6 rounded-lg bg-white dark:bg-[#18181B] border border-slate-200/80 dark:border-zinc-800 border-l-2 border-l-blue-600 space-y-4 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-5 gap-3 text-xs bg-slate-50 dark:bg-zinc-900/60 p-3.5 rounded-lg border border-slate-200/60 dark:border-zinc-800">
                        ...
                        <div>
                            ...
                            <span class="inline-block mt-0.5 px-2 py-0.5 rounded text-[10px] font-extrabold uppercase {{ $activeOrder->payment_status === 'paid' ? 'bg-emerald-500/15 text-emerald-700 dark:text-emerald-300 border border-emerald-500/30' : 'bg-rose-500/15 text-rose-700 dark:text-rose-300 border border-rose-500/30' }}">
