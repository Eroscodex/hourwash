<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold font-['Outfit'] text-slate-900 dark:text-white">👤 Account & Profile Settings</h1>
        ...
        <div class="max-w-4xl space-y-6">
            ...
            <div class="app-card overflow-hidden shadow-xl">
                <div class="p-5 border-b border-black/10 dark:border-white/10 flex items-center justify-between">
                    <div>
                        <h3 class="text-base font-bold text-slate-900 dark:text-white font-['Outfit']">🔒 Change Password</h3>
