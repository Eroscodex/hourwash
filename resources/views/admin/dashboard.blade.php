                        ...
                        <div class="p-4 rounded-xl bg-black/5 dark:bg-[#2C2C2E] border border-black/5 dark:border-white/10 space-y-2">
                            ...
                            <div class="flex items-center justify-between gap-3">
                                ...
                                <div class="flex items-center gap-2 min-w-0">
                                    ...
                                    <div class="w-7 h-7 rounded-full bg-[#007AFF] text-white flex items-center justify-center font-bold text-xs flex-shrink-0">
                                ...
                                {{-- STARS --}}
                                <div class="flex items-center text-amber-400 gap-0.5 flex-shrink-0">
                            ...
                            <div class="pt-1">
                                ...
                                <p class="text-xs text-slate-600 dark:text-slate-300 italic break-words">
                                    "{{ $fb->comment }}"
                                </p>

                                <form method="POST"
                                      action="{{ route('feedback.destroy', $fb->id) }}"
                                      onsubmit="return confirm('Delete this customer feedback?')"
                                      class="mt-3">
                                    ...
                                    <button type="submit"
                                            class="text-rose-500 hover:text-rose-700 text-[10px] font-extrabold uppercase hover:underline transition">
                                        Delete
                                    </button>
