<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">Edit Service Package: {{ $service->name }}</h1>
        ...
        <div class="app-card p-6 sm:p-8 space-y-6">
            <form action="{{ route('admin.services.update', $service) }}" method="POST" class="space-y-4">
                ...
                <div class="pt-4 border-t border-black/10 dark:border-white/10 flex justify-end gap-3">
                    ...
                    <button type="submit" class="btn-primary text-xs">Update Service Package</button>
                </div>
            </form>
        </div>
