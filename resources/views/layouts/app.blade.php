                ...
                <nav class="p-4 space-y-1.5 text-sm font-medium">
                    @auth
                        @if(auth()->user()->isOwner())
                            ...
                            <a href="{{ route('admin.machines.index') }}" title="Manage Machines" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.machines.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:dark:bg-zinc-800' }}">
                        ...
                        @elseif(auth()->user()->isStaff())
                            ...
                            <a href="{{ route('staff.machines.index') }}" title="Manage Machines" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('staff.machines.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:dark:bg-zinc-800' }}">
                                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                                <div class="sidebar-text">
