...
<body class="bg-slate-50 dark:bg-[#09090B] text-slate-900 dark:text-zinc-100 font-['Inter'] antialiased selection:bg-blue-600 selection:text-white min-h-screen">
    ...
    <div class="flex min-h-screen relative overflow-x-hidden">
                ...
                <nav class="p-4 space-y-1.5 text-sm font-medium">
                    @auth
                        @if(auth()->user()->isOwner())
                            ...
                            <a href="{{ route('admin.dashboard') }}" title="Overall Reports & Dashboard" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.dashboard') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-900 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.laundry.index') }}" title="Manage Laundry Orders" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.laundry.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.machines.index') }}" title="Manage Machines" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.machines.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                ...
                                <div class="sidebar-text">
                                    ...
                                    <p class="text-[10px] opacity-75 font-normal block leading-tight mt-0.5 whitespace-nowrap">Add, Edit, & Remove Machines</p>
                                </div>
                            </a>

                            <a href="{{ route('admin.services.index') }}" title="Services & Pricing" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.services.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.users.index') }}" title="Manage Users" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.users.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                ...
                                <div class="sidebar-text">
                                    ...
                                    <p class="text-[10px] opacity-75 font-normal block leading-tight mt-0.5 whitespace-nowrap">Stamps, Add, Edit, & Remove Users</p>
                                </div>
                            </a>

                            <a href="{{ route('admin.sms.index') }}" title="Live SMS Outbox" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.sms.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.emails.index') }}" title="Live Email Outbox" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.emails.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                ...
                                <div class="sidebar-text">
                                    ...
                                    <p class="text-[10px] opacity-75 font-normal block leading-tight mt-0.5 whitespace-nowrap">email notification logs</p>
                                </div>
                            </a>

                            <a href="{{ route('admin.reviews.index') }}" title="Customer Reviews Outbox" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.reviews.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.１１８l-3.976-2.888c-.784-.57-.38-１．８１．５８８-１．８１h4．９１４a１ １ ０ ００．９５１-.６９l１．５１９-４．６７４z"/></svg>
                                <div class="sidebar-text">
                            ...
                            <a href="{{ route('admin.qr_scan_logs.index') }}" title="QR Scan Logs Outbox" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.qr_scan_logs.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a１ １ ０ ００１ －１．８１．５８８－１．８１h４．９１４a１ １ ０ ００．９５１－．６９l１．５１９－４．６７４z"/></svg>
                                <div class="sidebar-text">
                        ...
                        @elseif(auth()->user()->isStaff())
                            ...
                            <a href="{{ route('staff.dashboard') }}" title="Workstation Dashboard" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('staff.dashboard') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a２ ２ ０ ０１２ －２v２a２ ２ ０ ０１－２ －２H６a２ ２ ０ ０１－２ －２v－２zM14 16a２ ２ ０ ０１２ －２h２a２
                            </a>

                            <a href="{{ route('staff.laundry.index') }}" title="Manage Laundry Orders" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('staff.laundry.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                                <div class="sidebar-text">
                            ...
                            <a href="{{ route('staff.machines.index') }}" title="Manage Machines" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('staff.machines.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                                <div class="sidebar-text">
                                    <span class="block leading-snug">Manage Machines</span>
                                    <p class="text-[10.5px] opacity-75 font-normal block leading-tight mt-0.5">Add, Edit, & Remove Machines</p>
                                </div>
                            </a>

                            <a href="{{ route('laundry.create') }}" title="New Walk-in Order" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('laundry.create') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('staff.qr_scan_logs.index') }}" title="QR Scan Logs Outbox" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('staff.qr_scan_logs.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a１ １ ０ ００１ －１zM5 2０h２a１ １ ０ ００１ －１v－２a１ １ ０ ００－１ －１H５a１ １ ０ ００－１ －１v２a１ １ ０ ００１ －１z"/></svg>
                                <div class="sidebar-text">
                        ...
                        @else
                            ...
                            <a href="{{ route('dashboard') }}" title="Customer Dashboard" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('dashboard') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('laundry.create') }}" title="Book New Order" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('laundry.create') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                                <div class="sidebar-text">
                            ...
                            <a href="{{ route('my.orders') }}" title="My Order History" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('my.orders') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('frequent_card.index') }}" title="Frequent User Card" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('frequent_card.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
        ...
        <div id="main-wrapper" class="flex-1 flex flex-col min-w-0 md:pl-64 transition-[padding] duration-300">
                ...
                <div class="flex items-center gap-2 sm:gap-4">
                    <button id="theme-toggle" class="p-2 px-3 rounded-lg bg-slate-100 dark:dark:bg-zinc-800 text-slate-900 dark:text-zinc-100 border border-slate-200 dark:dark:border-zinc-700 transition-all text-xs font-semibold flex items-center gap-1.5 shadow-sm" title="Toggle Light/Dark Theme">
                        ...
                        <span class="hidden dark:flex items-center gap-1.5">
                            <svg class="w-3.5 h-3.5 text-rose-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"/></svg>
                            Dark
                        </span>
                    </button>
            ...
            <footer class="border-t border-slate-200 dark:dark:border-zinc-700 py-3.5 px-4 md:px-8 bg-white dark:bg-[#141417] w-full">
                <div class="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-4 text-[10.5px] sm:text-[11px] text-slate-500 dark:text-zinc-400">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-x-3 gap-y-1">
                        ...
                        <span class="text-slate-300 dark:text-zinc-700">•</span>
                        <span class="font-medium text-slate-600 dark:text-zinc-300">Magallanes St., Orosite, Legazpi City</span>
                    </div>
                </div>
            </footer>
