        ...
        <aside id="sidebar" class="fixed top-0 bottom-0 left-0 h-screen w-64 bg-white dark:bg-[#141417] border-r border-slate-200 dark:dark:border-zinc-700 z-50 transform -translate-x-full md:translate-x-0 transition-[width,transform] duration-300 flex flex-col justify-between shadow-sm">
                ...
                <nav class="p-4 space-y-1.5 text-sm font-medium">
                    @auth
                        @if(auth()->user()->isOwner())
                            ...
                            <a href="{{ route('admin.dashboard') }}" title="Overall Reports & Dashboard" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.dashboard') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-900 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.laundry.index') }}" title="Manage Laundry Orders" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.laundry.*') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.machines.index') }}" title="Manage Machines" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.machines.*') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.services.index') }}" title="Services & Pricing" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.services.*') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.users.index') }}" title="Manage Users" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.users.*') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.sms.index') }}" title="Live SMS Outbox" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.sms.*') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.emails.index') }}" title="Live Email Outbox" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.emails.*') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.reviews.index') }}" title="Customer Reviews Outbox" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.reviews.*') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                        ...
                        @elseif(auth()->user()->isRider())
                            ...
                            <a href="{{ route('rider.dashboard') }}" title="Rider Logistics Dashboard" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('rider.dashboard') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                        ...
                        @elseif(auth()->user()->isStaff())
                            ...
                            <a href="{{ route('staff.dashboard') }}" title="Workstation Dashboard" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('staff.dashboard') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('staff.laundry.index') }}" title="Manage Laundry Orders" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('staff.laundry.*') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                                <div class="sidebar-text">
                            ...
                            <a href="{{ route('staff.machines.index') }}" title="Manage Machines" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('staff.machines.*') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                                <div class="sidebar-text">
                            ...
                            <a href="{{ route('laundry.create') }}" title="New Walk-in Order" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('laundry.create') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('staff.qr_scan_logs.index') }}" title="QR Scan Logs Outbox" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('staff.qr_scan_logs.*') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                        ...
                        @else
                            ...
                            <a href="{{ route('dashboard') }}" title="Customer Dashboard" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('dashboard') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('laundry.create') }}" title="Book New Order" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('laundry.create') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                                <div class="sidebar-text">
                            ...
                            <a href="{{ route('my.orders') }}" title="My Order History" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('my.orders') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('frequent_card.index') }}" title="Frequent User Card" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg transition-all {{ request()->routeIs('frequent_card.*') ? 'bg-rose-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                        ...
                        @endphp
                        <a href="{{ $profileRoute }}" title="Account Settings" class="sidebar-nav-item flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800 font-medium transition-all">
            ...
            <div id="sidebar-user-box" class="p-4 border-t border-slate-200 dark:dark:border-zinc-700 bg-slate-50 dark:bg-white/5 transition-all">
                <div class="flex items-center justify-start gap-3 w-full transition-all">
                    <div class="w-10 h-10 rounded-lg bg-rose-600 dark:bg-rose-600 text-white flex items-center justify-center font-bold shadow-sm shrink-0">
                    ...
                    <div class="sidebar-text flex-1 overflow-hidden">
                        ...
                        <p class="text-[11px] text-rose-600 dark:text-rose-400 capitalize flex items-center gap-1 font-extrabold">
                            <span class="w-1.5 h-1.5 rounded-full bg-rose-600 dark:bg-rose-600 inline-block animate-pulse"></span>
                            {{ auth()->user()->role }}
                        </p>
                    </div>
                </div>
