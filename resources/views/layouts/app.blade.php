    ...
    <div class="flex min-h-screen relative overflow-x-hidden">
        ...
        <aside id="sidebar" class="fixed top-0 bottom-0 left-0 h-screen w-64 bg-white dark:bg-[#141417] border-r border-slate-200 dark:border-zinc-700 z-50 transform -translate-x-full md:translate-x-0 transition-[width,transform] duration-300 flex flex-col justify-between shadow-sm">
            ...
            <div class="flex flex-col flex-1 min-h-0 overflow-y-auto">
                ...
                <nav class="p-1.5 space-y-0 text-sm font-medium">
                    @auth
                        @if(auth()->user()->isOwner())
                            <div class="sidebar-section-header px-2.5 py-0.5 text-[10px] font-extrabold text-slate-900 dark:text-slate-200 uppercase tracking-wider">Navigation</div>

                            <a href="{{ route('admin.dashboard') }}" title="Overall Reports & Dashboard" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('admin.dashboard') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-900 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.laundry.index') }}" title="Manage Laundry Orders" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('admin.laundry.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.machines.index') }}" title="Manage Machines" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('admin.machines.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.services.index') }}" title="Services & Pricing" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('admin.services.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.users.index') }}" title="Manage Users" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('admin.users.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.sms.index') }}" title="Live SMS Outbox" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('admin.sms.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.emails.index') }}" title="Live Email Outbox" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('admin.emails.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('admin.reviews.index') }}" title="Customer Reviews Outbox" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('admin.reviews.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                        ...
                        @elseif(auth()->user()->isStaff())
                            ...
                            <a href="{{ route('staff.dashboard') }}" title="Workstation Dashboard" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('staff.dashboard') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>
                                <div class="sidebar-text">
                            ...
                            <a href="{{ route('staff.laundry.index') }}" title="Manage Laundry Orders" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('staff.laundry.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                                <div class="sidebar-text">
                                    <span class="block leading-snug text-[11px] font-bold whitespace-nowrap">Manage Laundry Orders</span>
                                    <p class="text-[9.5px] opacity-75 font-normal block leading-tight whitespace-nowrap">Queue & cashier processing</p>
                            ...
                            <a href="{{ route('staff.machines.index') }}" title="Manage Machines" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('staff.machines.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                                <div class="sidebar-text">
                                    <span class="block leading-snug text-[11px] font-bold whitespace-nowrap">Manage Machines</span>
                                    <p class="text-[9.5px] opacity-75 font-normal block leading-tight whitespace-nowrap">Add, Edit, & Remove Machines</p>
                            ...
                            <a href="{{ route('laundry.create') }}" title="New Walk-in Order" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('laundry.create') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                        ...
                        @else
                            ...
                            <a href="{{ route('dashboard') }}" title="Customer Dashboard" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('dashboard') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('laundry.create') }}" title="Book New Order" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('laundry.create') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                                <div class="sidebar-text">
                            ...
                            <a href="{{ route('my.orders') }}" title="My Order History" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('my.orders') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
                            ...
                            <a href="{{ route('frequent_card.index') }}" title="Frequent User Card" class="sidebar-nav-item flex items-center gap-2.5 px-2.5 py-1 rounded-lg transition-all {{ request()->routeIs('frequent_card.*') ? 'bg-blue-600 text-white font-bold shadow-sm' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800' }}">
    ...
    <div id="universal-receipt-modal" onclick="if(event.target === this) closeReceiptModal()" class="fixed inset-0 z-[9999] hidden items-center justify-center bg-slate-900/70 dark:bg-black/85 backdrop-blur-sm p-2 sm:p-4 transition-all duration-200">
        <div class="relative w-full max-w-md bg-slate-100 dark:bg-zinc-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-zinc-800 max-h-[92vh] flex flex-col overflow-hidden animate-fade-in">
            ...
            <div class="p-2 flex-1 flex justify-center items-center bg-slate-200/60 dark:bg-zinc-950/80 overflow-hidden">
                <iframe id="receipt-modal-iframe" src="about:blank" scrolling="no" class="w-full h-[520px] max-h-[85vh] border-0 rounded-lg bg-slate-200 dark:bg-zinc-950 overflow-hidden"></iframe>
            </div>
        </div>
    </div>
