...
<body class="bg-slate-50 dark:bg-[#09090B] text-slate-900 dark:text-zinc-100 font-['Inter'] antialiased min-h-screen py-10 px-4 sm:px-6">
    <div class="w-full max-w-3xl mx-auto space-y-6">
        ...
        <main class="bg-white dark:bg-[#141417] border border-slate-200 dark:border-zinc-600 rounded-lg p-6 sm:p-8 space-y-8 shadow-sm">
            ...
            <section class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <article class="bg-slate-50 dark:bg-[#18181B] border border-black/5 dark:border-white/5 rounded-lg p-6 flex flex-col items-center text-center space-y-4 shadow-sm hover:scale-[1.02] transition-transform duration-300">
                    ...
                    <div class="space-y-1">
                        <h2 class="text-base font-bold text-slate-900 dark:text-white">Karl Nicko L. Alondra</h2>
                ...
                <article class="bg-slate-50 dark:bg-[#18181B] border border-black/5 dark:border-white/5 rounded-lg p-6 flex flex-col items-center text-center space-y-4 shadow-sm hover:scale-[1.02] transition-transform duration-300">
                    ...
                    <div class="space-y-1">
                        <h2 class="text-base font-bold text-slate-900 dark:text-white">Lezil O. Orgasa</h2>
                ...
                <article class="bg-slate-50 dark:bg-[#18181B] border border-black/5 dark:border-white/5 rounded-lg p-6 flex flex-col items-center text-center space-y-4 shadow-sm hover:scale-[1.02] transition-transform duration-300">
                    ...
                    <div class="space-y-1">
                        <h2 class="text-base font-bold text-slate-900 dark:text-white">Shayne Marie R. Formento</h2>
                ...
                <article class="bg-slate-50 dark:bg-[#18181B] border border-black/5 dark:border-white/5 rounded-lg p-6 flex flex-col items-center text-center space-y-4 shadow-sm hover:scale-[1.02] transition-transform duration-300">
                    ...
                    <div class="space-y-1">
                        <h2 class="text-base font-bold text-slate-900 dark:text-white">Alexa P. Cas</h2>
            ...
            <footer class="border-t border-slate-200 dark:border-zinc-700 pt-6 text-center text-xs text-slate-500 dark:text-slate-400">
        ...
        <footer class="pt-4 border-t border-slate-200 dark:border-zinc-800 text-center text-[11px] text-slate-500 dark:text-zinc-400 space-y-2.5">
            ...
            <div>© {{ date('Y') }} A Web-Based Laundry Management System for Hour Wash Laundry Shop in Orosite, Legazpi City</div>
        </footer>
    </div>
