...
def draw_oval(ax, x, y, w, h, text, fontsize=10.5):
    patch = patches.FancyBboxPatch((x, y), w, h, boxstyle='round,pad=0.2,rounding_size=2.0',
                                  fc='#FFFFFF', ec='#000000', lw=1.5, zorder=4)
    ax.add_patch(patch)
    ax.text(x + w/2.0, y + h/2.0, text, fontsize=fontsize, fontweight='bold', ha='center', va='center', color='#000000', zorder=5)

def draw_parallelogram(ax, x, y, w, h, text, fontsize=10.0, slant=2.2):
    pts = [[x + slant, y], [x + w + slant, y], [x + w, y + h], [x, y + h]]
    patch = patches.Polygon(pts, fc='#FFFFFF', ec='#000000', lw=1.5, zorder=4)
    ax.add_patch(patch)
    ax.text(x + w/2.0 + slant/2.0, y + h/2.0, text, fontsize=fontsize, fontweight='bold', ha='center', va='center', color='#000000', zorder=5)

def draw_diamond(ax, x, y, w, h, text, fontsize=10.0):
    pts = [[x + w/2.0, y + h], [x + w, y + h/2.0], [x + w/2.0, y], [x, y + h/2.0]]
    patch = patches.Polygon(pts, fc='#FFFFFF', ec='#000000', lw=1.5, zorder=4)
    ax.add_patch(patch)
    ax.text(x + w/2.0, y + h/2.0, text, fontsize=fontsize, fontweight='bold', ha='center', va='center', color='#000000', zorder=5)

def draw_rectangle(ax, x, y, w, h, text, fontsize=10.0):
    patch = patches.Rectangle((x, y), w, h, fc='#FFFFFF', ec='#000000', lw=1.5, zorder=4)
    ax.add_patch(patch)
    ax.text(x + w/2.0, y + h/2.0, text, fontsize=fontsize, fontweight='bold', ha='center', va='center', color='#000000', zorder=5)

def draw_connector(ax, cx, cy, r, label, fontsize=11.0):
    circle = patches.Circle((cx, cy), r, fc='#FFFFFF', ec='#000000', lw=1.5, zorder=4)
    ax.add_patch(circle)
...
def generate_login_flowchart():
    ...
    ax.text(5, 96, 'Figure 1', fontsize=14, fontweight='normal', color='#000000')
    ax.text(5, 93, 'Login Page Flowchart', fontsize=16, fontweight='bold', color='#000000')
    ax.plot([5, 30], [91.5, 91.5], color='#000000', lw=1.5)
    ...
    ax.annotate('', xy=(30.0, 78.5), xytext=(30.0, 84.0),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)

    # Connector T -> Display Login Page
    ax.annotate('', xy=(20.2, 75.5), xytext=(10.5, 75.5),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ...
    ax.annotate('', xy=(45.1, 51.75), xytext=(40.0, 51.75),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(42.5, 52.8, 'no', fontsize=10.0, color='#000000', ha='center', va='bottom')

    # Display Error -> Loopback to Display Login Page
    ax.plot([54.0, 54.0], [54.5, 75.5], color='#000000', lw=1.5, zorder=10)
    ...
    ax.annotate('', xy=(30.0, 42.5), xytext=(30.0, 47.0),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(31.2, 44.5, 'yes', fontsize=10.0, color='#000000', ha='left', va='center')
    ...
    ax.annotate('', xy=(69.1, 39.75), xytext=(64.0, 39.75),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(66.5, 40.8, 'yes', fontsize=10.0, color='#000000', ha='center', va='bottom')
    ...
    ax.annotate('', xy=(55.0, 27.5), xytext=(55.0, 35.0),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(56.2, 31.0, 'no', fontsize=10.0, color='#000000', ha='left', va='center')

    # Staff Yes -> Display staff dashboard
    ax.annotate('', xy=(69.1, 22.75), xytext=(64.0, 22.75),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(66.5, 23.8, 'yes', fontsize=10.0, color='#000000', ha='center', va='bottom')
    ...
    ax.annotate('', xy=(55.0, 10.5), xytext=(55.0, 18.0),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(56.2, 14.0, 'no', fontsize=10.0, color='#000000', ha='left', va='center')

    # Admin Yes -> Display admin dashboard
    ax.annotate('', xy=(69.1, 5.75), xytext=(64.0, 5.75),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(66.5, 6.8, 'yes', fontsize=10.0, color='#000000', ha='center', va='bottom')
    ...
    ax.plot([55.0, 55.0, 15.0, 15.0], [1.0, -3.0, -3.0, 64.75], color='#000000', lw=1.5, zorder=10)
    ax.annotate('', xy=(19.1, 64.75), xytext=(15.0, 64.75),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(35.0, -2.5, 'no', fontsize=10.0, color='#000000', ha='center', va='bottom')
...
def generate_customer_order_flowchart():
    ...
    ax.text(5, 96, 'Figure 2', fontsize=14, fontweight='normal', color='#000000')
    ax.text(5, 93, 'Customer Order Placement Flowchart', fontsize=16, fontweight='bold', color='#000000')
    ax.plot([5, 48], [91.5, 91.5], color='#000000', lw=1.5)
    ...
    ax.annotate('', xy=(45.1, 42.25), xytext=(40.0, 42.25),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(42.5, 43.3, 'no', fontsize=10.0, color='#000000', ha='center', va='bottom')
    ...
    ax.annotate('', xy=(30.0, 33.0), xytext=(30.0, 37.5),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(31.2, 35.0, 'yes', fontsize=10.0, color='#000000', ha='left', va='center')
...
def generate_staff_laundry_flowchart():
    ...
    ax.text(5, 96, 'Figure 3', fontsize=14, fontweight='normal', color='#000000')
    ax.text(5, 93, 'Staff Laundry Processing Flowchart', fontsize=16, fontweight='bold', color='#000000')
    ax.plot([5, 48], [91.5, 91.5], color='#000000', lw=1.5)
    ...
    ax.annotate('', xy=(45.1, 64.25), xytext=(40.0, 64.25),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(42.5, 65.3, 'no', fontsize=10.0, color='#000000', ha='center', va='bottom')

    # Display Error -> Loopback to Scan QR Code
    ax.plot([54.0, 54.0], [67.0, 77.25], color='#000000', lw=1.5, zorder=10)
    ...
    ax.annotate('', xy=(30.0, 55.0), xytext=(30.0, 59.5),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(31.2, 57.0, 'yes', fontsize=10.0, color='#000000', ha='left', va='center')
    ...
    ax.annotate('', xy=(44.0, 28.25), xytext=(40.0, 28.25),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(42.0, 29.3, 'no', fontsize=10.0, color='#000000', ha='center', va='bottom')

    # Continue Processing -> Loopback to Update Status
    ax.plot([55.0, 55.0], [31.0, 41.25], color='#000000', lw=1.5, zorder=10)
    ...
    ax.annotate('', xy=(30.0, 19.0), xytext=(30.0, 23.5),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(31.2, 21.0, 'yes', fontsize=10.0, color='#000000', ha='left', va='center')
...
def generate_qr_tracking_flowchart():
    ...
    ax.text(5, 96, 'Figure 4', fontsize=14, fontweight='normal', color='#000000')
    ax.text(5, 93, 'QR Code Tracking & Notification Flowchart', fontsize=16, fontweight='bold', color='#000000')
    ax.plot([5, 58], [91.5, 91.5], color='#000000', lw=1.5)
    ...
    ax.annotate('', xy=(44.0, 26.75), xytext=(40.0, 26.75),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(42.0, 27.8, 'no', fontsize=10.0, color='#000000', ha='center', va='bottom')

    # Status Updated? Yes -> Trigger TextBee SMS
    ax.annotate('', xy=(30.0, 17.5), xytext=(30.0, 22.0),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(31.2, 19.5, 'yes', fontsize=10.0, color='#000000', ha='left', va='center')
...
def generate_admin_management_flowchart():
    ...
    ax.text(5, 96, 'Figure 5', fontsize=14, fontweight='normal', color='#000000')
    ax.text(5, 93, 'System Administration & Management Flowchart', fontsize=16, fontweight='bold', color='#000000')
    ax.plot([5, 68], [91.5, 91.5], color='#000000', lw=1.5)
    ...
    ax.annotate('', xy=(12.0, 53.0), xytext=(20.0, 64.25),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(14.0, 60.0, 'accounts', fontsize=9.0, color='#000000', ha='right', va='center')

    # Option 2: Inventory & Pricing
    ax.annotate('', xy=(30.0, 53.0), xytext=(30.0, 59.5),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(31.2, 57.0, 'inventory', fontsize=9.0, color='#000000', ha='left', va='center')

    # Option 3: Sales Reports & Analytics
    ax.annotate('', xy=(48.0, 53.0), xytext=(40.0, 64.25),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(46.0, 60.0, 'reports', fontsize=9.0, color='#000000', ha='left', va='center')

    # Rejoin lines -> Commit Configuration
    ax.plot([12.0, 12.0, 48.0, 48.0], [47.5, 41.5, 41.5, 47.5], color='#000000', lw=1.5, zorder=10)
    ax.plot([30.0, 30.0], [47.5, 41.5], color='#000000', lw=1.5, zorder=10)
    ...
    ax.plot([40.0, 66.0, 66.0], [9.25, 9.25, 77.25], color='#000000', lw=1.5, zorder=10)
    ax.annotate('', xy=(44.1, 77.25), xytext=(66.0, 77.25),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(41.5, 10.3, 'yes', fontsize=10.0, color='#000000', ha='center', va='bottom')

    # Continue Admin Session No -> Logout & End
    ax.annotate('', xy=(30.0, -1.0), xytext=(30.0, 4.5),
                arrowprops=dict(arrowstyle='->', lw=1.5, color='#000000', shrinkA=0, shrinkB=0), zorder=10)
    ax.text(31.2, 2.0, 'no', fontsize=10.0, color='#000000', ha='left', va='center')
